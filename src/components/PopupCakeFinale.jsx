...
const PopupCakeFinale = () => {
  ...
  return (
    <section style={{ padding: 'clamp(32px, 7vw, 56px) clamp(16px, 5vw, 36px)', borderTop: '2px dashed #C4A785', textAlign: 'center', position: 'relative' }}>
      ...
      >
        ...
        <div style={{ marginBottom: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div style={{ marginBottom: '10px' }}>
            <div className="craft-stamp">
              ...
              <span className={language === 'hi' ? 'font-kalam' : 'font-caveat'} style={{ fontSize: '1.2rem' }}>
                {language === 'hi' ? 'किरीगामी पॉप-अप केक' : 'KIRIGAMI POP-UP CAKE'}
              </span>
          ...
          >
            {isCandleBlown 
              ? (language === 'hi' ? '🎉 मोमबत्ती बुझ गई! आपकी हर दुआ पूरी हो! 🎂' : '🎉 Candle Blown! May all your wishes come true! 🎂') 
              : (language === 'hi' ? 'मोमबत्ती बुझाने और कन्फेटी उड़ाने के लिए टैप करें 🕯️' : 'Tap to blow out the candle & make a wish! 🕯️')}
          </span>
        </div>
        ...
        {/* Family Collage in Papercraft Frame */}
        <div style={{
          maxWidth: '440px',
        ...
        <div style={{
          ...
          >
            ✂️ 3D PAPERCRAFT MASTERPIECE · HANDMADE FOR MAA ✂️
          </span>
        </div>
      </motion.div>
    </section>
...
export default PopupCakeFinale;
