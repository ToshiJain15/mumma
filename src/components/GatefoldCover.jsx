      ...
      {!isOpened && (
        <motion.div
          ...
          style={{
            ...
            padding: '16px',
            background: 'radial-gradient(circle at 50% 30%, #362014 0%, #1A0F08 85%, #0C0603 100%)',
            perspective: '1600px'
          }}
        >
          {/* Subtle Ambient Dried Petals */}
          ...
          <div style={{
            ...
            <motion.div
              ...
              style={{
                width: '50%',
                height: '100%',
                backgroundColor: 'var(--kraft-rich)',
                borderTopLeftRadius: '18px',
                borderBottomLeftRadius: '18px',
                border: '3px solid #B89C76',
                borderRight: '1.5px dashed #7D6142',
                boxShadow: 'var(--shadow-gatefold-left)',
            ...
            >
              ...
              <div style={{ zIndex: 2 }}>
                ...
                >
                  {language === 'hi' ? 'माँ-बेटी का रिश्ता ❤️' : "A Daughter's Card for Maa ❤️"}
                </span>
              </div>
              ...
              <div style={{ zIndex: 2 }}>
                ...
                >
                  {language === 'hi' ? 'हाथ से बना प्यार भरा स्क्रैपबुक...' : 'Handcrafted scrapbook memories...'}
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: 'var(--shadow-gatefold-right)',
              ...
              <div style={{
                ...
                >
                  ...
                  <span className={language === 'hi' ? 'font-kalam' : 'font-caveat'}>
                    {language === 'hi' ? 'गेटफोल्ड कार्ड खोलें ✂️✨' : 'Untie & Open Card ✂️✨'}
                  </span>
                </motion.button>
              </div>
            )}
