...
import { Camera, X, Heart, Sparkles, SlidersHorizontal } from 'lucide-react';
...
const ScrapbookStory = () => {
  ...
  return (
    <section style={{ padding: 'clamp(28px, 6vw, 48px) clamp(16px, 5vw, 36px)', borderTop: '2px dashed #BD9E78' }}>
      {/* Header */}
      <div style={{ textAlign: 'center', marginBottom: '34px' }}>
        <div style={{ marginBottom: '10px' }}>
          <div className="craft-stamp" style={{ transform: 'rotate(-1deg)' }}>
            ...
            <span className={language === 'hi' ? 'font-kalam' : 'font-caveat'} style={{ fontSize: '1.25rem' }}>
              {language === 'hi' ? 'माँ-बेटी का स्क्रैपबुक' : 'MOTHER-DAUGHTER MEMORY BOOK'}
            </span>
          </div>
        </div>
        ...
        <p 
          ...
          style={{
            fontSize: language === 'hi' ? '1.1rem' : '1.3rem',
      ...
      <div style={{
        ...
        {memoriesData.map((item, idx) => {
          ...
          return (
            ...
            >
              {/* Floral Washi Tape */}
              <div className="washi-tape-floral" style={{
                top: '-12px',
                left: '50%',
              ...
              <p 
                className={language === 'hi' ? 'font-kalam' : 'font-caveat'}
                style={{
                  fontSize: language === 'hi' ? '1.15rem' : '1.65rem',
                  color: 'var(--ink-navy)',
                  textAlign: 'center',
                  lineHeight: 1.25,
                  fontWeight: 700
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                <p 
                  className={language === 'hi' ? 'font-kalam' : 'font-caveat'}
                  style={{
                    fontSize: language === 'hi' ? '1.3rem' : '2rem',
                    color: 'var(--ink-navy)',
                    fontWeight: 700
                  }}
                >
